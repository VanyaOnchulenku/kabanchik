...
function Home () {
    return (  
        <div>
           ...
           <button type="submit"> <Link to ='/myorders'> Check my orders  </Link> </button>
           ...
           <button type="submit"> <Link to ='/mysuggestions'>  Check my suggestions </Link> </button>
            <h1>Here is our orders website</h1>
            <h2>Here you can leave your order and wait for somebody's respose</h2>
